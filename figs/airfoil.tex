\begin{tikzpicture}
  ...
  \draw[scale=\c,rotate=-10] plot file{figs/naca4415.dat} -- cycle;
  \draw[rotate=-10,dashed] (-0.55*\c,0)--(0.85*\c,0);
  \draw[->, >=stealth,gray] (-0.65*\c,0)--(0.85*\c,0) node[below,black]{\Large $z$};
  \draw[->, >=stealth,gray] (0,-0.2*\c)--(0,0.55*\c) node[left,black]{\Large $y$};
